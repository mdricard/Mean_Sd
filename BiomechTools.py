...
def max_min(curve, first_pt, last_pt):
    """finds the maximum and minimum values in the curve[] array between first_pt and last_pt.

    Args:
        curve (_type_): a single dimension array of data points.
        first_pt (_type_): first point in array curve[] to begin search.
        last_pt (_type_): last point in array curve[] to end search.

    Returns:
        _type_: max, min, max_location, min_location
    """
